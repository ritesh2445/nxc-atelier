    ...
    <>
        ...
        <div className="grid md:grid-cols-12 gap-10">
          <Reveal className="md:col-span-5">
            <div className="aspect-[4/5] border border-border bg-gradient-to-br from-surface to-background relative">
              <div className="absolute inset-0 flex items-center justify-center font-display text-lg text-gold/30">RM</div>
            </div>
          </Reveal>
          <Reveal delay={0.1} className="md:col-span-7 space-y-5 text-foreground/80 leading-relaxed">
            ...
            <p className="font-display text-lg text-foreground leading-snug">"I started NXC Badge because creators deserve the same caliber of work that Fortune 500s pay millions for — without the bureaucracy that makes it bad."</p>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        <Reveal><p className="text-xs uppercase tracking-[0.3em] text-gold mb-4">Values</p>
          <h2 className="font-display text-lg md:text-lg max-w-3xl">Four pillars. Non-negotiable.</h2></Reveal>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border mt-16">
          {values.map((v, i) => (
            <Reveal key={v.t} delay={i * 0.05} className="bg-background p-10">
              ...
              <h3 className="font-display text-lg mt-4">{v.t}</h3>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        <Reveal><p className="text-xs uppercase tracking-[0.3em] text-gold mb-4">Stack</p>
          <h2 className="font-display text-lg md:text-lg">Tools we trust.</h2></Reveal>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        <Reveal><p className="text-xs uppercase tracking-[0.3em] text-gold mb-4">Team</p>
          <h2 className="font-display text-lg md:text-lg">Six people. One standard.</h2></Reveal>
          ...
          {team.map((m, i) => {
            ...
            return (
              <Reveal key={m.name} delay={i * 0.05} className="border border-border p-8 text-center group hover:border-gold transition">
                <div className="mx-auto h-32 w-32 rounded-full bg-gradient-to-br from-surface to-background border border-border group-hover:border-gold/60 transition flex items-center justify-center font-display text-xl text-gold">{initials}</div>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-24">
        <Reveal className="border border-border p-12 md:p-16 bg-surface/40">
          ...
          <h2 className="font-display text-xl md:text-xl mt-6 max-w-3xl leading-tight">NXC Badge is part of a larger network of studios, creators and operators — quietly building the next generation of creator-first brands.</h2>
      ...
      <section className="mx-auto max-w-[1400px] px-6 md:px-10 py-32">
        <Reveal>
          <h2 className="font-display text-[clamp(1.875rem,4.5vw,3.75rem)] leading-[0.95]">Want to work together?</h2>
